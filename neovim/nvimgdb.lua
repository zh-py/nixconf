vim.cmd([[
	...
	autocmd Filetype python nnoremap <silent> <F5> :w<CR>:GdbStartPDB python3 % -m pdb<CR>
	autocmd Filetype python map! <silent> <F5> <ESC> :w<CR>:GdbStartPDB python3 % -m pdb<CR>
